...
class MPlusBotWebhook:
    def __init__(
        ...
        self.normalised_manga = self.normalise_manga(
            len(self.chapters), self.failed_chapters_num, self.skipped
        )
    ...
    def normalise_manga(
        ...
        attributes = self.manga["attributes"]
